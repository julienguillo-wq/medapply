...
const HOUSING_SITES = [
  ...
  { name: 'ImmoScout24.ch', description: 'Annonces immobilières dans toute la Suisse', url: 'https://www.immoscout24.ch', iconBg: 'bg-blue-100', iconText: 'text-blue-600' },
  { name: 'Comparis.ch/immobilier', description: 'Comparateur et annonces immobilières', url: 'https://www.comparis.ch/immobilien', iconBg: 'bg-orange-100', iconText: 'text-orange-600' },
...
export default function LogementPage() {
  ...
  const checklistItems = [
    { id: 'housingFound', label: 'Logement trouvé', checked: logement.housingFound },
    { id: 'leaseSigned', label: 'Bail signé', checked: logement.leaseSigned },
    { id: 'addressRegistered', label: 'Adresse enregistrée en commune (contrôle des habitants)', checked: logement.addressRegistered },
  ];
  ...
  return (
    <div className="animate-fade">
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-[15px]">Trouvez votre logement et préparez votre installation</p>
      </div>
      ...
      <Card className="mb-6 animate-slide">
        ...
        <p className="text-sm text-gray-400 mb-4">Loyer mensuel pour un 2-3 pièces</p>
      ...
      <div className="space-y-3 mb-8">
        <TipCard>
          <strong>Dossier de candidature locatif :</strong> Préparez un extrait de l'Office des poursuites, une attestation de salaire (ou contrat de travail), une copie de votre pièce d'identité et une lettre de motivation.
        </TipCard>
        <TipCard variant="warning">
          Commencez vos recherches <strong>2-3 mois avant</strong> votre date d'arrivée prévue. Le marché est très tendu dans les grandes villes.
        </TipCard>
      </div>
